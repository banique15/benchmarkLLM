              ...
              <div className="p-4 overflow-y-auto flex-grow">
                <div className="mb-4">
                  <input
                    ...
                    placeholder="Search default test cases..."
                    ...
                    .map((testCase) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <h4 className="font-medium text-dark-600 mb-1">{testCase.name}</h4>
                          <p className="text-sm text-gray-600 line-clamp-2">{testCase.prompt.substring(0, 100)}...</p>
                        </div>
                      );
                    })}
                </div>
