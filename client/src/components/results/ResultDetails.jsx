...
import AdvancedResultsView from './AdvancedResultsView';
      ...
      <div className="card overflow-hidden mb-8">
        <div className="border-b border-gray-200 bg-white">
          <nav className="flex overflow-x-auto">
            ...
            {result.benchmark_configs?.benchmark_type === 'advanced' && (
              <button
                className={`py-4 px-6 text-center border-b-2 font-medium text-sm transition-colors ${
                  activeTab === 'advanced'
                    ? 'border-primary-500 text-primary-600 bg-blue-50'
        ...
        <div className="p-6">
          ...
          {activeTab === 'advanced' && (
            <AdvancedResultsView benchmarkResult={result} benchmarkConfig={result.benchmark_configs} />
          )}
        </div>
      </div>
    </div>
